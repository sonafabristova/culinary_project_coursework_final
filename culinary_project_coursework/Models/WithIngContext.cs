...
public partial class WithIngContext : DbContext
{
    public WithIngContext()
    {
    }

    public WithIngContext(DbContextOptions<WithIngContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-FETHMEHK;Initial Catalog=with_ing;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdДня).HasName("PK__Дни_меню__648E240CB1DFDF1D");
        ...
        {
            entity.HasKey(e => e.IdЕдиницыИзмерения).HasName("PK__Единица___6B22633B7A5FBF0C");
        ...
        {
            entity.HasKey(e => e.IdИнгредиента).HasName("PK__Ингредие__53BA254F11AD7A59");
        ...
        {
            entity.HasKey(e => e.IdЧеловека).HasName("PK__Люди_в_м__03338709A3B89CB5");
        ...
        {
            entity.HasKey(e => e.IdМеню).HasName("PK__Меню__E94DDB61F3ACF6DC");
        ...
        {
            entity.HasKey(e => e.IdПользователя).HasName("PK__Пользова__AF763DA7A6C48D1A");
        ...
        {
            entity.HasKey(e => e.IdПриема).HasName("PK__Приемы_п__9D2BEDB909F564F1");
        ...
        {
            entity.HasKey(e => e.IdРецепта).HasName("PK__Рецепты__D9EF2C872FB11051");
        ...
        {
            entity.HasKey(e => e.IdСостава).HasName("PK__Состав_б__43F5EBD74ACEE5A8");
        ...
        {
            entity.HasKey(e => e.IdСписка).HasName("PK__Списки_п__40602DD9579FB010");
        ...
        {
            entity.HasKey(e => e.IdШага).HasName("PK__Шаги_при__4EC6B0059A0F5418");
        ...
        {
            entity.HasKey(e => e.IdЭлемента).HasName("PK__Элементы__FA698E3537984A4D");
