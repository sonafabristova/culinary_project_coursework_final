...
public partial class BdCourseContext : DbContext
{
    public BdCourseContext()
    {
    }

    public BdCourseContext(DbContextOptions<BdCourseContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-FETHMEHK;Initial Catalog=BD_course;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdДня).HasName("PK__Дни_меню__648E240C8B7C0B9E");
        ...
        {
            entity.HasKey(e => e.IdЕдиницыИзмерения).HasName("PK__Единица___6B22633BACBBD328");
        ...
        {
            entity.HasKey(e => e.IdИнгредиента).HasName("PK__Ингредие__53BA254F8492374C");
        ...
        {
            entity.HasKey(e => e.IdЧеловека).HasName("PK__Люди_в_м__03338709547ADE09");
        ...
        {
            entity.HasKey(e => e.IdМеню).HasName("PK__Меню__E94DDB61FDE0257C");
        ...
        {
            entity.HasKey(e => e.IdПользователя).HasName("PK__Пользова__AF763DA72438B235");
        ...
        {
            entity.HasKey(e => e.IdПриема).HasName("PK__Приемы_п__9D2BEDB9DAACEEBB");
        ...
        {
            entity.HasKey(e => e.IdРецепта).HasName("PK__Рецепты__D9EF2C8746142F6A");
        ...
        {
            entity.HasKey(e => e.IdСостава).HasName("PK__Состав_б__43F5EBD745F476C7");
        ...
        {
            entity.HasKey(e => e.IdСписка).HasName("PK__Списки_п__40602DD90D0D53C3");
        ...
        {
            entity.HasKey(e => e.IdШага).HasName("PK__Шаги_при__4EC6B005C080A097");
        ...
        {
            entity.HasKey(e => e.IdЭлемента).HasName("PK__Элементы__FA698E3566E5760D");
